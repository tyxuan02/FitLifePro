...
class CommonInjury(KnowledgeEngine):
    ...
    def sprain(self):
        ...
        image = Image.open('images/images_injury/sprain.jpg')
    ...
    def strain(self):
        ...
        image = Image.open('images/images_injury/strain.jpg')
        st.image(image, use_column_width=True)
    ...
    def knee_injury(self):
        ...
        image = Image.open('images/images_injury/knee-injury.jpg')
        st.image(image, use_column_width=True)
    ...
    def fracture(self):
        ...
        image = Image.open('images/images_injury/fracture.jpg')
        st.image(image, use_column_width=True)
    ...
    def swollen_muscles(self):
        ...
        image = Image.open('images/images_injury/muscle-cramps.jpg')
        st.image(image, use_column_width=True)
    ...
    def nose_injury(self):
        ...
        image = Image.open('images/images_injury/nose-injury.jpg')
        st.image(image, use_column_width=True)
    ...
    def bruise(self):
        ...
        image = Image.open('images/images_injury/bruise.jpeg')
        st.image(image, use_column_width=True)
    ...
    def cut_and_abrasion(self):
        ...
        image = Image.open('images/images_injury/cut-and-abrasion.jpg')
        st.image(image, use_column_width=True)
    ...
    def dental_damange(self):
        ...
        image = Image.open('images/images_injury/dental-damage.jpg')
        st.image(image, use_column_width=True)
    ...
    def discolation(self):
        ...
        image = Image.open('images/images_injury/dislocation.jpeg')
        st.image(image, use_column_width=True)
...
class Treatment(KnowledgeEngine):
    ...
    def first_aid_for_nose_bleeds(self):
        ...
        image = Image.open('images/images_injury/first-aid-for-nose-bleeds.jpg')
        st.image(image, use_column_width=True)
    ...
    def first_aid_for_dislodged_teeth(self):
        ...
        image = Image.open('images/images_injury/first-aid-for-dislodged-teeth.jpg')
        st.image(image, use_column_width=True)
        st.markdown("""<strong style="text-style: bold; font-size: 20px;">
    ...
    def emergency_situation(self):
        ...
        image = Image.open('images/images_injury/emergency-situation.png')
        st.image(image, use_column_width=True)
        st.markdown("""<strong style="text-style: bold; font-size: 20px;">
        Call ambulance for:
...
class Prevention(KnowledgeEngine):
    ...
    def warm_up(self):
        ...
        image = Image.open('images/images_injury/warm-up.jpg')
        st.image(image, use_column_width=True)
        ...
        <ul>
            <li><strong style="text-style: bold; font-size: 20px;">Stretching</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Fast-paced Walking</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Arm Swings</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Leg Swings</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Squats</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">High Knees</strong></li>
        </ul>
        </strong>""", unsafe_allow_html=True)
    ...
    def exercise_regularly(self):
        ...
        image = Image.open('images/images_injury/exercise-regularly.jpg')
        st.image(image, use_column_width=True)
    ...
    def push_body(self):
        ...
        image = Image.open('images/images_injury/push-body.jpg')
        st.image(image, use_column_width=True)
    ...
    def proper_technique(self):
        ...
        image = Image.open('images/images_injury/proper-technique.jpg')
        st.image(image, use_column_width=True)
    ...
    def proper_equipment(self):
        ...
        image = Image.open('images/images_injury/proper-equipment.jpg')
        st.image(image, use_column_width=True)
    ...
    def cool_down(self):
        ...
        image = Image.open('images/images_injury/cool-down.jpg')
        st.image(image, use_column_width=True)
        ...
        <ul>
            <li><strong style="text-style: bold; font-size: 20px;">Walking</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Stretching</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Yoga</strong></li>
            <li><strong style="text-style: bold; font-size: 20px;">Deep Breathing</strong></li>
        </ul>
        </strong>""", unsafe_allow_html=True)
    ...
    def resume_activity(self):
        ...
        image = Image.open('images/images_injury/resume-activity.jpg')
        st.image(image, use_column_width=True)
