...
class TeamSports(KnowledgeEngine):
    ...
    def Football(self):
        ...
        image = Image.open('images_sport/football.jpeg')
    ...
    def Basketball(self):
        ...
        image = Image.open('images_sport/basketball.jpg')
        st.image(image, use_column_width=True)
    ...
    def Rugby(self):
        ...
        image = Image.open('images_sport/rugby.jpg')
        st.image(image, use_column_width=True)
    ...
    def Hockey(self):
        ...
        image = Image.open('images_sport/hockey.jpg')
        st.image(image, use_column_width=True)
